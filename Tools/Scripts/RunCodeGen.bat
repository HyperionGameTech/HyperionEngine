...
Build\hyperion-codegen.exe --WorkingDirectory=%WORKING_DIR% --SourceDirectory=%WORKING_DIR%\Source --CXXOutputDirectory=%WORKING_DIR%\Source\Generated --CSharpOutputDirectory=%WORKING_DIR%\Source\Generated\CSharp --StrataOutputDirectory=%WORKING_DIR%\Data\Scripts\Strata --ExcludeDirectories=%WORKING_DIR%\Source\Generated --ExcludeFiles=%WORKING_DIR%\Source\Core\Defines.hpp
