...
if [[ $RESP =~ ^[Yy] ]]; then
    ...
    if [[ $IOS -eq 1 ]]; then
        ...
        HYP_CMAKE_PARAMS="-DHYP_THIRD_PARTY_LIBRARY_DIRECTORY=$SCRIPT_DIR/../../Binaries/ThirdParty -DHYP_LIBRARY_OUTPUT_DIRECTORY=$SCRIPT_DIR/../../Binaries/Engine -DHYP_RUNTIME_OUTPUT_DIRECTORY=$SCRIPT_DIR/../../Binaries/Engine" -DHYP_ROOT_DIR=$SCRIPT_DIR/../..
