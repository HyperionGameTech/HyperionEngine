...
extern void InstancedMeshProxy_OnPostLoad(InstancedMeshProxy&);

HYP_CLASS(PostLoad = "InstancedMeshProxy_OnPostLoad")
class InstancedMeshProxy : public AssetObject
{
...
public:
    ...
    InstancedMeshProxy() = default;

    explicit InstancedMeshProxy(Name name)
        : AssetObject(name)
    {
    }
