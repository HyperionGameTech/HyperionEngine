    ...
    if (image->uri != nullptr && *image->uri)
    {
        ...
        auto TryLoadTexture = [&](const String& candidate) -> Handle<Texture>
        {
                ...
                srgb ? AssetLoadHint::TextureLoader_LoadAsSRGB : AssetLoadHint::NoHint); textureResult.HasValue())
            {
                ...
                GetCurrentAssetRegistry()->RegisterAsset("$Import/Textures", texture);
    ...
    const Name& baseName)
{
    ...
    GetCurrentAssetRegistry()->RegisterAsset("$Import/Textures", roughnessTexture);
    ...
    GetCurrentAssetRegistry()->RegisterAsset("$Import/Textures", metalnessTexture);
    ...
    PrimitiveBuildOutput& out)
{
    ...
    GetCurrentAssetRegistry()->RegisterAsset("$Import/Meshes", mesh);
