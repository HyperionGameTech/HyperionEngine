...
*/
struct ENGINE_API CustomRenderCommand : RenderCommand
{
...
public:
    ...
    */
    static ENGINE_API void PushCustomRenderCommand(CustomRenderCommand* command);
