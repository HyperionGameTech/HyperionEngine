...
{
    const float qx = TerrainFbm2D(TerrainHashU32(seed ^ 0x51ED2701u), xz.x * frequency + 11.3f, xz.y * frequency + 7.7f, 4);
    const float qy = TerrainFbm2D(TerrainHashU32(seed ^ 0x68BC21EBu), xz.x * frequency + 3.1f, xz.y * frequency + 17.9f, 4);
