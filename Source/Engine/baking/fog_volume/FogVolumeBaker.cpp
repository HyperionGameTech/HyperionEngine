...
void Baker<FogVolume>::HandleCompletedJob_Internal(BakeJobBase* job)
{
    ...
    GetCurrentAssetRegistry()->RegisterAsset("$Memory/Lightmaps", volumeTexture, AddAssetConflictMode::ReplaceExisting);
    ...
    GetCurrentAssetRegistry()->RegisterAsset("$Memory/Lightmaps", noiseTexture, AddAssetConflictMode::ReplaceExisting);
