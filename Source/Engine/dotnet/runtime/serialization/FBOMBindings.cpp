...
#define FBOM_TYPE_CREATE_FUNCTION(fbomTypeName, functionSuffix) \
    ...
    FBOM_TYPE_CREATE_FUNCTION(Mat3f, Mat3f)
    FBOM_TYPE_CREATE_FUNCTION(Mat4f, Mat4f)
...
#define FBOM_TYPE_GET_SET_FUNCTIONS(fbomTypeName, functionSuffix, cType)          \
    ...
    FBOM_TYPE_GET_SET_FUNCTIONS(Mat3f, Mat3f, Mat3f)
    FBOM_TYPE_GET_SET_FUNCTIONS(Mat4f, Mat4f, Mat4f)
