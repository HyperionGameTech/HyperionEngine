...
namespace Hyperion
{
    public delegate ObjectReference NewObjectDelegate([MarshalAs(UnmanagedType.I1)] bool keepAlive, IntPtr pManagedClass, IntPtr nativeAddress, IntPtr pCtx, IntPtr pCallback);
