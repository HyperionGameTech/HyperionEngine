...
DECLARE_SRV_COND(BindlessResources1, Buffers, ShaderInputType::STORAGE_BUFFER, ~0u, g_renderInterface->GetRenderConfig().bindlessTextures && g_renderInterface->GetRenderConfig().rayTracing);