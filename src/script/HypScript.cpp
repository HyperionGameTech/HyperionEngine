...
SymbolTypeRef TypeIdToSymbolTypeImpl(TypeId typeId)
{
    static const HashMap<TypeId, SymbolTypeRef> s_builtinTypes = {
        ...
        { g_typeIdI8, BuiltinTypes::s_int8Type },
        { g_typeIdI16, BuiltinTypes::s_int16Type },
        { g_typeIdI32, BuiltinTypes::s_int32Type },
        { g_typeIdI64, BuiltinTypes::s_int64Type },
        { g_typeIdU8, BuiltinTypes::s_uint8Type },
        { g_typeIdU16, BuiltinTypes::s_uint16Type },
