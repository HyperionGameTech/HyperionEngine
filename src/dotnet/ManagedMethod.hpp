...
public:
    ...
    HYP_FORCE_INLINE void Invoke(ObjectReference* thisObjectReference, const BoxedValue** argsBoxed, BoxedValue* outReturnHypData) const
    {
        m_invokeFptr(thisObjectReference, argsBoxed, outReturnHypData);
    }
