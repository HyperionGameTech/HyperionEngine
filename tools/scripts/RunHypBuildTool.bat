...
build\hyperion-buildtool.exe --WorkingDirectory=%WORKING_DIR% --SourceDirectory=%WORKING_DIR%\src --CXXOutputDirectory=%WORKING_DIR%\generated --CSharpOutputDirectory=%WORKING_DIR%\generated\csharp --HypScriptOutputDirectory=%WORKING_DIR%\build\bin --ExcludeDirectories=%WORKING_DIR%\generated --ExcludeFiles=%WORKING_DIR%\src\core\Defines.hpp
