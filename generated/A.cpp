...
HYP_BEGIN_CLASS(HypObjectBase, 0, 218, {})
HYP_END_CLASS
...
HYP_BEGIN_ENUM(UIMenuBarDropDirection, 221, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectSize, 222, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectAspectRatio, 223, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateSizeFlags, 224, 0, {})
...
HYP_BEGIN_ENUM(UIObjectAlignment, 225, 0, {})
...
HYP_BEGIN_STRUCT(UIEventHandlerResult, 226, 0, {}, HypClassAttribute("size", 24))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(UIObjectBorderFlags, 227, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateType, 228, 0, {})
...
HYP_BEGIN_ENUM(UIObjectFocusState, 229, 0, {})
...
HYP_BEGIN_ENUM(ScrollAxis, 230, 0, {})
...
HYP_BEGIN_ENUM(UIListViewOrientation, 231, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 232, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 233, 0, {})
...
HYP_BEGIN_STRUCT(ScriptData, 234, 0, {})
...
HYP_BEGIN_STRUCT(WeakName, 235, 0, {})
...
HYP_BEGIN_STRUCT(HashCode, 237, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(CommandLineArgumentDefinitions, 238, 0, {}, HypClassAttribute("size", 8))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(CommandLineArguments, 239, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(CommandLineArgumentType, 240, 0, {})
...
HYP_BEGIN_STRUCT(Vertex, 241, 0, {}, HypClassAttribute("size", 128),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(VertexAttributeSet, 242, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Transform, 244, 0, {}, HypClassAttribute("size", 112),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Triangle, 246, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Quaternion, 247, 0, {}, HypClassAttribute("size", 16))
...
HYP_BEGIN_STRUCT(BoundingSphere, 248, 0, {}, HypClassAttribute("size", 32))
...
HYP_BEGIN_ENUM(RayTestFlags, 249, 0, {})
...
HYP_BEGIN_STRUCT(Ray, 250, 0, {}, HypClassAttribute("size", 32),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Frustum, 251, 0, {}, HypClassAttribute("size", 224),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(BoundingBox, 253, 0, {}, HypClassAttribute("size", 32))
...
HYP_BEGIN_STRUCT(Error, 256, 0, {}, HypClassAttribute("size", 16))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Result, 257, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_STRUCT(DynamicLibrary, 258, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_STRUCT(LogChannel, 259, 0, {})
...
HYP_BEGIN_ENUM(HypClassFlags, 260, 0, {})
...
HYP_BEGIN_STRUCT(AssetReference, 266, 0, {}, HypClassAttribute("size", 16))
