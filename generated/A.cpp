...
HYP_BEGIN_CLASS(HypObjectBase, 0, 215, {})
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(AssetPath, 219, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_STRUCT(AssetReference, 220, 0, {}, HypClassAttribute("size", 16))
...
HYP_BEGIN_CLASS(ConsoleUI, 196, 0, NAME("UIObject"))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(HashCode, 231, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(WeakName, 232, 0, {})
...
HYP_BEGIN_STRUCT(CommandLineArgumentDefinitions, 234, 0, {}, HypClassAttribute("size", 8))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DynamicLibrary, 237, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_STRUCT(BoundingBox, 239, 0, {}, HypClassAttribute("size", 32))
...
HYP_BEGIN_STRUCT(BoundingSphere, 240, 0, {}, HypClassAttribute("size", 32))
...
HYP_BEGIN_STRUCT(Frustum, 242, 0, {}, HypClassAttribute("size", 224),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Mat3f, 243, 0, {}, HypClassAttribute("size", 48))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Mat4f, 244, 0, {}, HypClassAttribute("size", 64))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Ray, 247, 0, {}, HypClassAttribute("size", 32),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Transform, 248, 0, {}, HypClassAttribute("size", 112),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Triangle, 249, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Vertex, 250, 0, {}, HypClassAttribute("size", 128),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(VertexAttributeSet, 251, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_ENUM(HypClassFlags, 252, 0, {})
...
HYP_BEGIN_STRUCT(Time, 256, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Uuid, 257, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_ENUM(EditorActionStackState, 258, 0, {})
...
HYP_BEGIN_ENUM(EditorCameraControllerMode, 259, 0, {})
...
HYP_BEGIN_CLASS(EditorCameraController, 175, 0, NAME("FirstPersonCameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EditorSubsystem, 149, 0, NAME("Subsystem"))
