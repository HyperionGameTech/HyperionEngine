...
HYP_BEGIN_CLASS(UISubsystem, 161, 0, NAME("Subsystem"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(VertexAttributeSet, 237, 0, {})
...
HYP_BEGIN_STRUCT(Transform, 238, 0, {}, HypClassAttribute("size", 112),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Triangle, 239, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Matrix4, 242, 0, {}, HypClassAttribute("size", 64))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Matrix3, 243, 0, {}, HypClassAttribute("size", 48))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Ray, 244, 0, {}, HypClassAttribute("size", 32),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Frustum, 245, 0, {}, HypClassAttribute("size", 224),HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(BoundingBox, 247, 0, {}, HypClassAttribute("size", 32))
...
HYP_BEGIN_STRUCT(Time, 248, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Uuid, 249, 0, {}, HypClassAttribute("serialize", "bitwise"))
...
HYP_BEGIN_STRUCT(Error, 250, 0, {}, HypClassAttribute("size", 128))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Result, 251, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_CLASS(TextureAsset, 46, 0, NAME("AssetObject"))
...
HYP_BEGIN_CLASS(ScriptAsset, 47, 0, NAME("AssetObject"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(AssetPackageFlags, 256, 0, {})
...
HYP_BEGIN_STRUCT(AssetReference, 257, 0, {}, HypClassAttribute("size", 16))
...
HYP_BEGIN_CLASS(AssetObject, 45, 7, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_ENUM(AssetObjectFlags, 258, 0, {})
...
HYP_BEGIN_STRUCT(AssetPath, 259, 0, {}, HypClassAttribute("size", 8))
...
HYP_BEGIN_STRUCT(MeshData, 260, 0, {})
...
HYP_BEGIN_CLASS(MeshAsset, 48, 0, NAME("AssetObject"))
...
HYP_BEGIN_STRUCT(MeshDesc, 261, 0, {})
