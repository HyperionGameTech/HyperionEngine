...
HYP_BEGIN_ENUM(NodeFlags, 358, 0, {}, ClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 359, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 360, 0, {})
...
HYP_BEGIN_CLASS(Node, 131, 14, NAME("ObjectBase"), ClassAttribute("postload", "Node_OnPostLoad"))
