...
HYP_BEGIN_ENUM(NodeFlags, 357, 0, {}, ClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 358, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 359, 0, {})
...
HYP_BEGIN_CLASS(Node, 130, 14, NAME("ObjectBase"), ClassAttribute("postload", "Node_OnPostLoad"))
