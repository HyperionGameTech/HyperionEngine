...
HYP_BEGIN_STRUCT(HBAOConfig, 344, 0, {}, ClassAttribute("configname", "GlobalConfig"),ClassAttribute("jsonpath", "Rendering.HBAO"))
...
HYP_BEGIN_CLASS(HBAO, 125, 0, NAME("FullScreenPass"), ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
