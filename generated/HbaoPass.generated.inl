...
HYP_BEGIN_STRUCT(HBAOConfig, 345, 0, {}, ClassAttribute("configname", "GlobalConfig"),ClassAttribute("jsonpath", "Rendering.HBAO"))
...
HYP_BEGIN_CLASS(HBAO, 126, 0, NAME("FullScreenPass"), ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
