...
HYP_BEGIN_ENUM(ShaderModuleType, 338, 0, {})
...
HYP_BEGIN_CLASS(ShaderBase, 104, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
