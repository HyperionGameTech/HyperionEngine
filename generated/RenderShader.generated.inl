...
HYP_BEGIN_ENUM(ShaderModuleType, 337, 0, {})
...
HYP_BEGIN_CLASS(ShaderBase, 103, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
