...
HYP_BEGIN_ENUM(MaterialAttributeFlags, 284, 0, {})
    ...
    StaticField(NAME(HYP_STR(MAF_STENCIL_TEST)), MaterialAttributeFlags::MAF_STENCIL_TEST),
...
HYP_BEGIN_STRUCT(MaterialAttributes, 285, 0, {})
    ...
    Field(NAME(HYP_STR(StencilReference)), &MaterialAttributes::stencilReference, offsetof(MaterialAttributes, stencilReference)),
...
HYP_BEGIN_STRUCT(MeshAttributes, 286, 0, {})
