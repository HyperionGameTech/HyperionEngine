...
HYP_BEGIN_ENUM(EnvProbeType, 343, 0, {})
...
HYP_BEGIN_STRUCT(GameState, 344, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 345, 0, {})
...
HYP_BEGIN_ENUM(LightFlags, 346, 0, {})
...
HYP_BEGIN_ENUM(LightType, 347, 0, {})
...
HYP_BEGIN_ENUM(NodeFlags, 348, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 349, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 350, 0, {})
...
HYP_BEGIN_ENUM(SceneFlags, 351, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityState, 352, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(VisibilityStateSnapshot, 353, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Keyframe, 354, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 355, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 356, 0, {})
...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 357, 0, {})
...
HYP_BEGIN_STRUCT(AnimationComponent, 358, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 359, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 360, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 361, 0, {})
...
HYP_BEGIN_ENUM(AudioLoopMode, 362, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 363, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 364, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 365, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 366, 0, {})
