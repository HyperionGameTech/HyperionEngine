...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 354, 0, {})
...
HYP_BEGIN_CLASS(VulkanRenderPass, 138, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true),HypClassAttribute("pool", "EPN_RENDER"))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 356, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.debug.debugDrawer"))
...
HYP_BEGIN_ENUM(PhysicsShapeType, 358, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 367, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_ENUM(NodeFlags, 368, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 369, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 370, 0, {})
...
HYP_BEGIN_ENUM(LightFlags, 371, 0, {})
...
HYP_BEGIN_STRUCT(BVHNode, 373, 0, {})
...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 375, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 376, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 377, 0, {})
