...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 352, 0, {})
...
HYP_BEGIN_STRUCT(BVHNode, 353, 0, {})
...
HYP_BEGIN_ENUM(ComponentRWFlags, 355, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 356, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_ENUM(EntityTag, 357, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 358, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_ENUM(EnvProbeType, 359, 0, {})
...
HYP_BEGIN_STRUCT(GameState, 360, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 361, 0, {})
...
HYP_BEGIN_ENUM(LightFlags, 362, 0, {})
...
HYP_BEGIN_ENUM(LightType, 363, 0, {})
...
HYP_BEGIN_ENUM(NodeFlags, 364, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 365, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 366, 0, {})
...
HYP_BEGIN_ENUM(SceneFlags, 367, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityState, 368, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(VisibilityStateSnapshot, 369, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Keyframe, 370, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 371, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 372, 0, {})
