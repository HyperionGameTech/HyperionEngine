...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 346, 0, {})
...
HYP_BEGIN_STRUCT(BVHNode, 347, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 349, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_STRUCT(TagComponentBase, 351, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_ENUM(NodeFlags, 357, 0, {}, HypClassAttribute("flags", true))
