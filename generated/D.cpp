 ...
 * Source: rendering/shadows/ShadowRenderer.hpp
 */
...
HYP_BEGIN_CLASS(SkydomeRenderer, 152, 0, NAME("Subsystem"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 353, 0, {})
...
HYP_BEGIN_CLASS(VulkanFence, 130, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRenderPass, 131, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanBLAS, 127, 0, NAME("BLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanAccelerationGeometry, 132, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanTLAS, 125, 0, NAME("TLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRaytracingPipeline, 129, 0, NAME("RaytracingPipelineBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(BVHNode, 354, 0, {})
...
HYP_BEGIN_ENUM(ComponentRWFlags, 356, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 357, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_CLASS(Entity, 135, 12, NAME("Node"))
...
HYP_BEGIN_CLASS(EntityManager, 133, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(EntityTag, 358, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 359, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_CLASS(EnvGrid, 136, 1, NAME("Entity"))
...
HYP_BEGIN_CLASS(LegacyEnvGrid, 137, 0, NAME("EnvGrid"))
...
HYP_BEGIN_ENUM(EnvProbeType, 360, 0, {})
...
HYP_BEGIN_CLASS(EnvProbe, 138, 2, NAME("Entity"))
...
HYP_BEGIN_CLASS(ReflectionProbe, 139, 0, NAME("EnvProbe"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkyProbe, 140, 0, NAME("EnvProbe"))
...
HYP_BEGIN_STRUCT(GameState, 361, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 362, 0, {})
...
HYP_BEGIN_CLASS(DirectionalLight, 142, 0, NAME("Light"))
...
HYP_BEGIN_ENUM(LightFlags, 363, 0, {})
...
HYP_BEGIN_CLASS(AreaRectLight, 143, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightType, 364, 0, {})
...
HYP_BEGIN_CLASS(SpotLight, 144, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PointLight, 145, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Light, 141, 4, NAME("Entity"))
...
HYP_BEGIN_ENUM(NodeFlags, 365, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 366, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 367, 0, {})
...
HYP_BEGIN_CLASS(Node, 134, 14, NAME("HypObjectBase"), HypClassAttribute("postload", "Node_OnPostLoad"))
...
HYP_BEGIN_CLASS(ScriptableSystem, 155, 0, NAME("SystemBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(Subsystem, 149, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SystemBase, 154, 11, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(View, 166, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(VisibilityState, 369, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(VisibilityStateSnapshot, 370, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(World, 167, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(AnimationTrack, 168, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(Animation, 169, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(Bone, 148, 0, NAME("Node"))
...
HYP_BEGIN_STRUCT(Keyframe, 371, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 372, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 373, 0, {})
...
HYP_BEGIN_CLASS(CameraController, 170, 7, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(Camera, 146, 0, NAME("Entity"))
...
HYP_BEGIN_CLASS(NullCameraController, 171, 0, NAME("CameraController"))
HYP_END_CLASS
