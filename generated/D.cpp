 ...
 * Source: rendering/lightmapper/LightmapperSubsystem.hpp
 */
...
HYP_BEGIN_CLASS(VulkanFence, 136, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRenderPass, 137, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
