...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 358, 0, {})
...
HYP_BEGIN_CLASS(SkydomeRenderer, 165, 0, NAME("Subsystem"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 359, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 360, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.debug.debugDrawer"))
...
HYP_BEGIN_STRUCT(PhysicsMaterial, 361, 0, {})
...
HYP_BEGIN_ENUM(PhysicsShapeType, 362, 0, {})
...
HYP_BEGIN_CLASS(RigidBody, 143, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(SpherePhysicsShape, 145, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ConvexHullPhysicsShape, 146, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(BoxPhysicsShape, 147, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsShape, 144, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PlanePhysicsShape, 148, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(EnvProbeType, 363, 0, {})
...
HYP_BEGIN_CLASS(EnvProbe, 169, 2, NAME("Entity"))
...
HYP_BEGIN_CLASS(ReflectionProbe, 170, 0, NAME("EnvProbe"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkyProbe, 171, 0, NAME("EnvProbe"))
...
HYP_BEGIN_STRUCT(GameState, 364, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 365, 0, {})
...
HYP_BEGIN_CLASS(World, 149, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(EntityTag, 368, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 369, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_ENUM(ComponentRWFlags, 370, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 371, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_CLASS(Subsystem, 162, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(NodeFlags, 372, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 373, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 374, 0, {})
...
HYP_BEGIN_CLASS(Node, 167, 14, NAME("HypObjectBase"), HypClassAttribute("postload", "Node_OnPostLoad"))
...
HYP_BEGIN_CLASS(DirectionalLight, 173, 0, NAME("Light"))
HypMethod(NAME(HYP_STR(GetDirection)), &DirectionalLight::GetDirection),
    HypMethod(NAME(HYP_STR(SetDirection)), &DirectionalLight::SetDirection)
        HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightFlags, 375, 0, {})
HypConstant(NAME(HYP_STR(LF_NONE)), LightFlags::LF_NONE),
    HypConstant(NAME(HYP_STR(LF_SHADOW)), LightFlags::LF_SHADOW),
    HypConstant(NAME(HYP_STR(LF_SHADOW_PCF)), LightFlags::LF_SHADOW_PCF),
    HypConstant(NAME(HYP_STR(LF_SHADOW_CONTACT_HARDENING)), LightFlags::LF_SHADOW_CONTACT_HARDENING),
...
HYP_BEGIN_CLASS(AreaRectLight, 174, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightType, 376, 0, {})
HypConstant(NAME(HYP_STR(LT_DIRECTIONAL)), LightType::LT_DIRECTIONAL),
    HypConstant(NAME(HYP_STR(LT_POINT)), LightType::LT_POINT),
    HypConstant(NAME(HYP_STR(LT_SPOT)), LightType::LT_SPOT),
    HypConstant(NAME(HYP_STR(LT_AREA_RECT)), LightType::LT_AREA_RECT),
...
HYP_BEGIN_CLASS(SpotLight, 175, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PointLight, 176, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Light, 172, 4, NAME("Entity"))
HypMethod(NAME(HYP_STR(GetLightType)), &Light::GetLightType),
    HypMethod(NAME(HYP_STR(GetLightFlags)), &Light::GetLightFlags),
    HypMethod(NAME(HYP_STR(SetLightFlags)), &Light::SetLightFlags),
    HypMethod(NAME(HYP_STR(GetPosition)), &Light::GetPosition, Span<const HypClassAttribute> { { HypClassAttribute("property", "Position"), HypClassAttribute("editor", true) } }),
...
HYP_BEGIN_CLASS(View, 182, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(BVHNode, 377, 0, {})
...
HYP_BEGIN_CLASS(EntityManager, 183, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(SceneFlags, 378, 0, {})
...
HYP_BEGIN_CLASS(EnvGrid, 177, 1, NAME("Entity"))
...
HYP_BEGIN_CLASS(LegacyEnvGrid, 178, 0, NAME("EnvGrid"))
...
HYP_BEGIN_CLASS(Entity, 168, 12, NAME("Node"))
...
HYP_BEGIN_CLASS(PerspectiveCameraController, 185, 4, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 379, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 380, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 381, 0, {})
