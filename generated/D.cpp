 ...
 * Source: rendering/vulkan/VulkanAttachment.hpp
 */
...
HYP_BEGIN_CLASS(VulkanBLAS, 124, 0, NAME("BLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanAccelerationGeometry, 129, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanTLAS, 122, 0, NAME("TLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRaytracingPipeline, 126, 0, NAME("RaytracingPipelineBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(BVHNode, 351, 0, {})
...
HYP_BEGIN_ENUM(ComponentRWFlags, 353, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 354, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_ENUM(EntityTag, 355, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 356, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_ENUM(EnvProbeType, 357, 0, {})
