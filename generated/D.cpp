...
HYP_BEGIN_ENUM(LightmapShadingType, 362, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 363, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Lightmapper"))
...
HYP_BEGIN_ENUM(LightmapTraceMode, 364, 0, {})
...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 365, 0, {})
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 366, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 367, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Rendering.Debug.DebugDrawer"))
...
HYP_BEGIN_STRUCT(PhysicsMaterial, 368, 0, {})
...
HYP_BEGIN_ENUM(PhysicsShapeType, 369, 0, {})
...
HYP_BEGIN_ENUM(EnvProbeType, 370, 0, {})
...
HYP_BEGIN_STRUCT(GameState, 371, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 372, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityState, 373, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(VisibilityStateSnapshot, 374, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(EntityTag, 375, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 376, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_ENUM(ComponentRWFlags, 377, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 378, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_ENUM(NodeFlags, 379, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 380, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 381, 0, {})
...
HYP_BEGIN_ENUM(LightFlags, 382, 0, {})
...
HYP_BEGIN_ENUM(LightType, 383, 0, {})
...
HYP_BEGIN_STRUCT(BVHNode, 384, 0, {})
...
HYP_BEGIN_ENUM(SceneFlags, 386, 0, {})
