...
HYP_BEGIN_ENUM(LightmapShadingType, 360, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 361, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "lightmapper"))
...
HYP_BEGIN_ENUM(LightmapTraceMode, 362, 0, {})
...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 363, 0, {})
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 364, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 365, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.debug.debugDrawer"))
...
HYP_BEGIN_STRUCT(PhysicsMaterial, 366, 0, {})
...
HYP_BEGIN_ENUM(PhysicsShapeType, 367, 0, {})
...
HYP_BEGIN_ENUM(EnvProbeType, 368, 0, {})
...
HYP_BEGIN_STRUCT(TagComponentBase, 374, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(ComponentInfo, 376, 0, {}, HypClassAttribute("size", 12))
...
HYP_BEGIN_ENUM(NodeFlags, 377, 0, {}, HypClassAttribute("flags", true))
