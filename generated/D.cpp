...
HYP_BEGIN_STRUCT(GameState, 342, 0, {})
...
HYP_BEGIN_ENUM(GameStateMode, 343, 0, {})
...
HYP_BEGIN_ENUM(LightFlags, 344, 0, {})
...
HYP_BEGIN_ENUM(LightType, 345, 0, {})
...
HYP_BEGIN_ENUM(NodeFlags, 346, 0, {}, HypClassAttribute("flags", true))
...
HYP_BEGIN_STRUCT(NodeTagSet, 347, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(NodeTag, 348, 0, {})
...
HYP_BEGIN_CLASS(Scene, 23, 0, NAME("AssetObject"))
...
HYP_BEGIN_ENUM(SceneFlags, 349, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityState, 350, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(VisibilityStateSnapshot, 351, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(Keyframe, 352, 0, {})
...
HYP_BEGIN_ENUM(CameraProjectionMode, 353, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 354, 0, {})
...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 355, 0, {})
...
HYP_BEGIN_STRUCT(AnimationComponent, 356, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 357, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 358, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 359, 0, {})
...
HYP_BEGIN_ENUM(AudioLoopMode, 360, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 361, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 362, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 363, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 364, 0, {})
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 365, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 366, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(MeshComponent, 367, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 288),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
