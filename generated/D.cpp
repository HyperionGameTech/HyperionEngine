...
HYP_BEGIN_CLASS(SkydomeRenderer, 151, 0, NAME("Subsystem"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanFence, 129, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanFrame, 99, 0, NAME("FrameBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanFramebuffer, 101, 0, NAME("FramebufferBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanGpuBuffer, 103, 0, NAME("GpuBufferBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanGpuImage, 105, 0, NAME("GpuImageBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanGpuImageView, 107, 0, NAME("GpuImageViewBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanGraphicsPipeline, 109, 0, NAME("GraphicsPipelineBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRenderPass, 130, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanShader, 114, 0, NAME("ShaderBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanSwapchain, 117, 0, NAME("SwapchainBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanBLAS, 126, 0, NAME("BLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanAccelerationGeometry, 131, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanTLAS, 124, 0, NAME("TLASBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanRaytracingPipeline, 128, 0, NAME("RaytracingPipelineBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Entity, 134, 12, NAME("Node"))
...
HYP_BEGIN_CLASS(EntityManager, 132, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EnvGrid, 135, 1, NAME("Entity"))
...
HYP_BEGIN_CLASS(LegacyEnvGrid, 136, 0, NAME("EnvGrid"))
...
HYP_BEGIN_CLASS(EnvProbe, 137, 2, NAME("Entity"))
...
HYP_BEGIN_CLASS(ReflectionProbe, 138, 0, NAME("EnvProbe"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkyProbe, 139, 0, NAME("EnvProbe"))
...
HYP_BEGIN_CLASS(DirectionalLight, 141, 0, NAME("Light"))
...
HYP_BEGIN_CLASS(AreaRectLight, 142, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SpotLight, 143, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PointLight, 144, 0, NAME("Light"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Light, 140, 4, NAME("Entity"))
...
HYP_BEGIN_CLASS(Node, 133, 14, NAME("HypObjectBase"), HypClassAttribute("postload", "Node_OnPostLoad"))
...
HYP_BEGIN_CLASS(ScriptableSystem, 154, 0, NAME("SystemBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(Subsystem, 148, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SystemBase, 153, 11, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(View, 165, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(World, 166, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(AnimationTrack, 167, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(Animation, 168, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(Bone, 147, 0, NAME("Node"))
...
HYP_BEGIN_CLASS(CameraController, 169, 7, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(Camera, 145, 0, NAME("Entity"))
...
HYP_BEGIN_CLASS(NullCameraController, 170, 0, NAME("CameraController"))
HYP_END_CLASS
