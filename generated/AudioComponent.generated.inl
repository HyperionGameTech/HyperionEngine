...
HYP_BEGIN_ENUM(AudioLoopMode, 404, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 405, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 406, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 407, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 408, 0, {})
