...
HYP_BEGIN_ENUM(AudioLoopMode, 402, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 403, 0, {}, ClassAttribute("component", true),ClassAttribute("label", "Audio Component"),ClassAttribute("description", "Controls the state of an audio source."),ClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 404, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 405, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 406, 0, {})
