...
HYP_BEGIN_STRUCT(NodeLinkComponent, 379, 0, {}, ClassAttribute("component", true),ClassAttribute("size", 8),ClassAttribute("serialize", false),ClassAttribute("editor", false))
