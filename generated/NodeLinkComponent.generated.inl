...
HYP_BEGIN_STRUCT(NodeLinkComponent, 376, 0, {}, ClassAttribute("component", true),ClassAttribute("size", 8),ClassAttribute("serialize", false),ClassAttribute("editor", false))
