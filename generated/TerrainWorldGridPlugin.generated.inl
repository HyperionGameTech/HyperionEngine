...
HYP_BEGIN_CLASS(TerrainStreamingCell, 67, 0, NAME("StreamingCell"), ClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_CLASS(TerrainWorldGridLayer, 193, 0, NAME("WorldGridLayer"), ClassAttribute("noscriptbindings", true))
