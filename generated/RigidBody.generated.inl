...
HYP_BEGIN_ENUM(PhysicsShapeType, 272, 0, {})
...
HYP_BEGIN_CLASS(RigidBody, 62, 0, NAME("ObjectBase"))
...
HYP_BEGIN_CLASS(SpherePhysicsShape, 64, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ConvexHullPhysicsShape, 65, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(BoxPhysicsShape, 66, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsShape, 63, 4, NAME("ObjectBase"), ClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PlanePhysicsShape, 67, 0, NAME("PhysicsShape"))
HYP_END_CLASS
