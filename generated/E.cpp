...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 370, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 371, 0, {})
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 372, 0, {}, HypClassAttribute("component", true), HypClassAttribute("size", 64), HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 373, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 375, 0, {}, HypClassAttribute("component", true), HypClassAttribute("size", 8), HypClassAttribute("serialize", false), HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 376, 0, {}, HypClassAttribute("component", true), HypClassAttribute("size", 24), HypClassAttribute("label", "Reflection Probe Component"), HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"), HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 377, 0, {}, HypClassAttribute("component", true), HypClassAttribute("label", "Rigid Body Component"), HypClassAttribute("description", "Controls the properties of an object with rigid body physics."), HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(SkyComponent, 381, 0, {}, HypClassAttribute("component", true), HypClassAttribute("label", "Sky Component"), HypClassAttribute("description", "Controls the rendering of a dynamic skydome."), HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(TransformComponent, 382, 0, {}, HypClassAttribute("component", true), HypClassAttribute("label", "Transform Component"), HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."), HypClassAttribute("editor", false))
HypField(NAME(HYP_STR(Transform)), &TransformComponent::transform, offsetof(TransformComponent, transform), Span<const HypClassAttribute> { { HypClassAttribute("property", "Transform") } })
    HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(LightmapVolumeAtlas, 387, 0, {})
HypProperty(NAME(HYP_STR(AtlasDimensions)), &LightmapVolumeAtlas::atlasDimensions),
    HypProperty(NAME(HYP_STR(Elements)), &LightmapVolumeAtlas::elements),
    HypProperty(NAME(HYP_STR(FreeSpaces)), &LightmapVolumeAtlas::freeSpaces)
        HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(StreamingCellInfo, 395, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_ENUM(StreamingCellState, 396, 0, {})
...
HYP_BEGIN_ENUM(StreamingVolumeShape, 397, 0, {})
...
HYP_BEGIN_ENUM(UIListViewOrientation, 398, 0, {})
