...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 390, 0, {})
...
HYP_BEGIN_CLASS(FirstPersonCameraController, 188, 1, NAME("PerspectiveCameraController"))
...
HYP_BEGIN_CLASS(FollowCameraController, 190, 0, NAME("PerspectiveCameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(OrthoCameraController, 191, 0, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(CameraProjectionMode, 391, 0, {})
...
HYP_BEGIN_ENUM(CameraFlags, 392, 0, {})
...
HYP_BEGIN_CLASS(CameraController, 185, 7, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(Camera, 180, 0, NAME("Entity"))
...
HYP_BEGIN_CLASS(NullCameraController, 192, 0, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AnimationTrack, 193, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(Animation, 194, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(Keyframe, 393, 0, {})
...
HYP_BEGIN_CLASS(Bone, 182, 0, NAME("Node"))
...
HYP_BEGIN_CLASS(LightmapVolume, 181, 0, NAME("Entity"))
...
HYP_BEGIN_STRUCT(MeshComponent, 397, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 240),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(VisibilityStateFlags, 398, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityStateComponent, 399, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 32),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 400, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(TransformComponent, 401, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false),HypClassAttribute("serialize", false))
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 402, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 403, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_STRUCT(UIComponent, 404, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(AnimationComponent, 405, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 406, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 407, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 408, 0, {})
...
HYP_BEGIN_STRUCT(SkyComponent, 409, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioLoopMode, 410, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 411, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 412, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 413, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 414, 0, {})
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 415, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 416, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 417, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 418, 0, {})
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 419, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 24),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
HYP_BEGIN_CLASS(WorldAABBUpdaterSystem, 153, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsSystem, 154, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkySystem, 155, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VisibilityStateUpdaterSystem, 156, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EntityMeshDirtyStateSystem, 159, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapSystem, 161, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true),HypClassAttribute("description", "Associates an Entity with a MeshComponent with the assigned LightmapVolume, if applicable."))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AnimationSystem, 162, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 420, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_CLASS(WorldGridLayer, 195, 1, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(WorldGrid, 197, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(TerrainWorldGridLayer, 196, 0, NAME("WorldGridLayer"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_ENUM(EnginePoolName, 421, 0, {})
...
HYP_BEGIN_CLASS(EngineStats, 198, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EngineStatGroup, 199, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(EngineStatEntry, 422, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(EngineDriver, 200, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EditorActionStack, 201, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(EditorActionStackState, 423, 0, {})
