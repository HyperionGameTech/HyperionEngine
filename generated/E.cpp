...
HYP_BEGIN_CLASS(FollowCameraController, 188, 0, NAME("PerspectiveCameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(OrthoCameraController, 189, 0, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Bone, 180, 0, NAME("Node"))
...
HYP_BEGIN_CLASS(AnimationSystem, 160, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
