...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 373, 0, {})
...
HYP_BEGIN_STRUCT(AnimationComponent, 374, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 375, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 376, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 377, 0, {})
...
HYP_BEGIN_ENUM(AudioLoopMode, 378, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 379, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 380, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 381, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 382, 0, {})
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 383, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 384, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(MeshComponent, 385, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 240),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 386, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 387, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 24),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 388, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 389, 0, {})
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 390, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 391, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_STRUCT(SkyComponent, 392, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(TransformComponent, 393, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(UIComponent, 394, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(LightmapElement, 397, 0, {}, HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(LightmapVolumeAtlas, 398, 0, {})
...
HYP_BEGIN_ENUM(LightmapTextureType, 399, 0, {})
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 400, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_STRUCT(ScriptData, 401, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 402, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 403, 0, {})
...
HYP_BEGIN_STRUCT(StreamableKey, 404, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellNeighbor, 405, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellInfo, 406, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_ENUM(StreamingCellState, 407, 0, {})
...
HYP_BEGIN_ENUM(StreamingVolumeShape, 408, 0, {})
