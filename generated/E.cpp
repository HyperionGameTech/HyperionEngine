...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 367, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 368, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(MeshComponent, 369, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 288),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 370, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 371, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 24),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 372, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 373, 0, {})
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 374, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 375, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_STRUCT(SkyComponent, 376, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(TransformComponent, 377, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(UIComponent, 378, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(LightmapElement, 381, 0, {}, HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(LightmapVolumeAtlas, 382, 0, {})
...
HYP_BEGIN_ENUM(LightmapTextureType, 383, 0, {})
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 384, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_STRUCT(ScriptData, 385, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 386, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 387, 0, {})
...
HYP_BEGIN_STRUCT(StreamableKey, 388, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellNeighbor, 389, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellInfo, 390, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_ENUM(StreamingCellState, 391, 0, {})
...
HYP_BEGIN_ENUM(StreamingVolumeShape, 392, 0, {})
...
HYP_BEGIN_ENUM(UIListViewOrientation, 393, 0, {})
...
HYP_BEGIN_ENUM(UIMenuBarDropDirection, 394, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectSize, 395, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectAspectRatio, 396, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateSizeFlags, 397, 0, {})
...
HYP_BEGIN_ENUM(UIObjectAlignment, 398, 0, {})
...
HYP_BEGIN_STRUCT(UIEventHandlerResult, 399, 0, {}, HypClassAttribute("size", 24))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(UIObjectBorderFlags, 400, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateType, 401, 0, {})
...
HYP_BEGIN_ENUM(UIObjectFocusState, 402, 0, {})
...
HYP_BEGIN_ENUM(ScrollAxis, 403, 0, {})
