...
HYP_BEGIN_ENUM(AudioLoopMode, 367, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 368, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 369, 0, {})
...
HYP_BEGIN_STRUCT(MeshComponent, 374, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 288),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 378, 0, {})
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 379, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 380, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_ENUM(VisibilityStateFlags, 384, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityStateComponent, 385, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 32),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapElement, 386, 0, {}, HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_ENUM(LightmapTextureType, 388, 0, {})
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 389, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_STRUCT(ScriptData, 390, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 391, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 392, 0, {})
...
HYP_BEGIN_STRUCT(StreamableKey, 393, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellNeighbor, 394, 0, {})
