...
HYP_BEGIN_STRUCT(Keyframe, 372, 0, {})
...
HYP_BEGIN_STRUCT(LightmapElement, 373, 0, {}, HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(LightmapVolumeAtlas, 374, 0, {})
...
HYP_BEGIN_ENUM(LightmapTextureType, 375, 0, {})
...
HYP_BEGIN_STRUCT(MeshComponent, 376, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 288),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(VisibilityStateFlags, 377, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityStateComponent, 378, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 32),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 379, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(TransformComponent, 380, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false))
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 381, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 382, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_STRUCT(UIComponent, 383, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(AnimationComponent, 384, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 385, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 386, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 387, 0, {})
...
HYP_BEGIN_STRUCT(SkyComponent, 388, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioLoopMode, 389, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 390, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 391, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 392, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 393, 0, {})
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 394, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 395, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 396, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 397, 0, {})
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 398, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 32),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
static_assert(sizeof(ReflectionProbeComponent) == 32, "Expected sizeof(ReflectionProbeComponent) to be 32 bytes");
} // namespace hyperion
...
HYP_BEGIN_CLASS(WorldAABBUpdaterSystem, 150, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsSystem, 151, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkySystem, 152, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VisibilityStateUpdaterSystem, 153, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ScriptSystem, 157, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AnimationSystem, 159, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(TerrainStreamingCell, 64, 0, NAME("StreamingCell"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_CLASS(TerrainWorldGridLayer, 194, 0, NAME("WorldGridLayer"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_CLASS(EngineStats, 196, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EngineStatGroup, 197, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(EngineStatEntry, 400, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(EngineDriver, 198, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EditorActionStack, 199, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(EditorActionStackState, 401, 0, {})
...
HYP_BEGIN_CLASS(EditorCameraInputHandler, 59, 0, NAME("InputHandlerBase"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(EditorCameraControllerMode, 402, 0, {})
...
HYP_BEGIN_CLASS(EditorState, 200, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EditorProject, 201, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EditorActionBase, 202, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(FunctionalEditorAction, 203, 0, NAME("EditorActionBase"))
...
HYP_BEGIN_CLASS(EditorTaskBase, 204, 3, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(LongRunningEditorTask, 205, 0, NAME("EditorTaskBase"), HypClassAttribute("abstract", true),HypClassAttribute("description", "A task that runs on a Task thread and has Process called one time only"))
...
HYP_BEGIN_CLASS(TickableEditorTask, 206, 1, NAME("EditorTaskBase"), HypClassAttribute("abstract", true),HypClassAttribute("description", "A task that runs on the game thread and is has Process called every tick"))
