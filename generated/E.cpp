...
HYP_BEGIN_CLASS(CameraTrackController, 173, 0, NAME("PerspectiveCameraController"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(FirstPersonCameraControllerMode, 374, 0, {})
...
HYP_BEGIN_CLASS(FirstPersonCameraController, 174, 1, NAME("PerspectiveCameraController"))
...
HYP_BEGIN_CLASS(FollowCameraController, 176, 0, NAME("PerspectiveCameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(OrthoCameraController, 171, 0, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PerspectiveCameraController, 172, 4, NAME("CameraController"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(CameraStreamingVolume, 185, 0, NAME("StreamingVolumeBase"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(AnimationComponent, 375, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(AnimationPlaybackState, 376, 0, {})
...
HYP_BEGIN_ENUM(AnimationLoopMode, 377, 0, {})
...
HYP_BEGIN_ENUM(AnimationPlaybackStatus, 378, 0, {})
...
HYP_BEGIN_ENUM(AudioLoopMode, 379, 0, {})
...
HYP_BEGIN_STRUCT(AudioComponent, 380, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Audio Component"),HypClassAttribute("description", "Controls the state of an audio source."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(AudioComponentFlags, 381, 0, {})
...
HYP_BEGIN_ENUM(AudioPlaybackStatus, 382, 0, {})
...
HYP_BEGIN_STRUCT(AudioPlaybackState, 383, 0, {})
...
HYP_BEGIN_STRUCT(BoundingBoxComponent, 384, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 64),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(LightmapVolumeComponent, 385, 0, {}, HypClassAttribute("component", true))
...
HYP_BEGIN_STRUCT(MeshComponent, 386, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 240),HypClassAttribute("label", "Mesh Component"),HypClassAttribute("description", "Controls the rendering of an entity, including the mesh, material, and skeleton."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(NodeLinkComponent, 387, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 388, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 24),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 389, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 390, 0, {})
...
HYP_BEGIN_STRUCT(SkyComponent, 393, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(TransformComponent, 394, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(UIComponent, 395, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(LightmapElement, 398, 0, {}, HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(LightmapVolumeAtlas, 399, 0, {})
...
HYP_BEGIN_CLASS(LightmapVolume, 146, 0, NAME("Entity"))
...
HYP_BEGIN_ENUM(LightmapTextureType, 400, 0, {})
...
HYP_BEGIN_CLASS(AnimationSystem, 155, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EntityMeshDirtyStateSystem, 157, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EntityRenderProxySystem_Mesh, 158, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapSystem, 159, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true),HypClassAttribute("description", "Associates an Entity with a MeshComponent with the assigned LightmapVolume, if applicable."))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsSystem, 160, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ScriptSystem, 161, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SkySystem, 162, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VisibilityStateUpdaterSystem, 163, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(WorldAABBUpdaterSystem, 164, 0, NAME("SystemBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(WorldGrid, 177, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 401, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_CLASS(WorldGridLayer, 178, 1, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(TerrainStreamingCell, 182, 0, NAME("StreamingCell"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_CLASS(TerrainWorldGridLayer, 179, 0, NAME("WorldGridLayer"), HypClassAttribute("noscriptbindings", true))
...
HYP_BEGIN_STRUCT(ScriptData, 402, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 403, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 404, 0, {})
...
HYP_BEGIN_CLASS(StreamableBase, 180, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_STRUCT(StreamableKey, 405, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellNeighbor, 406, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellInfo, 407, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_CLASS(StreamingCell, 181, 1, NAME("StreamableBase"))
...
HYP_BEGIN_ENUM(StreamingCellState, 408, 0, {})
...
HYP_BEGIN_CLASS(StreamingManager, 183, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_ENUM(StreamingVolumeShape, 409, 0, {})
...
HYP_BEGIN_CLASS(StreamingVolumeBase, 184, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(SDLAppContext, 187, 0, NAME("AppContextBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AppContextBase, 186, 2, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SDLApplicationWindow, 190, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32ApplicationWindow, 191, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ApplicationWindow, 189, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32AppContext, 188, 0, NAME("AppContextBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(UIButton, 197, 0, NAME("UIObject"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(UIDataSource, 194, 0, NAME("UIDataSourceBase"))
...
HYP_BEGIN_CLASS(UIElementFactoryBase, 192, 0, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(UIDataSourceBase, 193, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
