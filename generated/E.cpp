...
HYP_BEGIN_STRUCT(NodeLinkComponent, 368, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(ReflectionProbeComponent, 369, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 32),HypClassAttribute("label", "Reflection Probe Component"),HypClassAttribute("description", "Handles cubemap reflection calculations for a single EnvProbe source"),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(RigidBodyComponent, 370, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Rigid Body Component"),HypClassAttribute("description", "Controls the properties of an object with rigid body physics."),HypClassAttribute("editor", true))
...
HYP_BEGIN_ENUM(RigidBodyComponentFlags, 371, 0, {})
...
HYP_BEGIN_ENUM(ScriptComponentFlags, 372, 0, {})
...
HYP_BEGIN_STRUCT(ScriptComponent, 373, 0, {}, HypClassAttribute("component", true),HypClassAttribute("noscriptbindings", true),HypClassAttribute("label", "Script Component"),HypClassAttribute("description", "A script component that can be attached to an entity."))
...
HYP_BEGIN_STRUCT(SkyComponent, 374, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Sky Component"),HypClassAttribute("description", "Controls the rendering of a dynamic skydome."),HypClassAttribute("editor", true))
...
HYP_BEGIN_STRUCT(TransformComponent, 375, 0, {}, HypClassAttribute("component", true),HypClassAttribute("label", "Transform Component"),HypClassAttribute("description", "Controls the translation, rotation, and scale of an object."),HypClassAttribute("editor", false))
...
HYP_BEGIN_STRUCT(UIComponent, 376, 0, {}, HypClassAttribute("component", true),HypClassAttribute("size", 8),HypClassAttribute("serialize", false))
...
HYP_BEGIN_STRUCT(WorldGridLayerInfo, 382, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_STRUCT(ScriptData, 383, 0, {})
...
HYP_BEGIN_ENUM(ScriptCompileStatus, 384, 0, {})
...
HYP_BEGIN_ENUM(ScriptLanguage, 385, 0, {})
...
HYP_BEGIN_STRUCT(StreamableKey, 386, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellNeighbor, 387, 0, {})
...
HYP_BEGIN_STRUCT(StreamingCellInfo, 388, 0, {}, HypClassAttribute("size", 80))
...
HYP_BEGIN_ENUM(StreamingCellState, 389, 0, {})
...
HYP_BEGIN_ENUM(StreamingVolumeShape, 390, 0, {})
...
HYP_BEGIN_ENUM(UIListViewOrientation, 391, 0, {})
...
HYP_BEGIN_ENUM(UIMenuBarDropDirection, 392, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectSize, 393, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectAspectRatio, 394, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateSizeFlags, 395, 0, {})
...
HYP_BEGIN_ENUM(UIObjectAlignment, 396, 0, {})
...
HYP_BEGIN_STRUCT(UIEventHandlerResult, 397, 0, {}, HypClassAttribute("size", 24))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(UIObjectBorderFlags, 398, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateType, 399, 0, {})
...
HYP_BEGIN_ENUM(UIObjectFocusState, 400, 0, {})
...
HYP_BEGIN_ENUM(ScrollAxis, 401, 0, {})
