...
HYP_BEGIN_CLASS(EditorTaskBase, 203, 3, NAME("ObjectBase"), ClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(LongRunningEditorTask, 204, 0, NAME("EditorTaskBase"), ClassAttribute("abstract", true),ClassAttribute("description", "A task that runs on a Task thread and has Process called one time only"))
...
HYP_BEGIN_CLASS(TickableEditorTask, 205, 1, NAME("EditorTaskBase"), ClassAttribute("abstract", true),ClassAttribute("description", "A task that runs on the game thread and is has Process called every tick"))
