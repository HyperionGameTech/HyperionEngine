...
HYP_BEGIN_CLASS(UIElementFactoryBase, 191, 0, NAME("ObjectBase"), ClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(UIDataSourceBase, 192, 1, NAME("ObjectBase"), ClassAttribute("abstract", true))
