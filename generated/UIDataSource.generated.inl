...
HYP_BEGIN_CLASS(UIElementFactoryBase, 2, 0, NAME("ObjectBase"), ClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(UIDataSourceBase, 3, 1, NAME("ObjectBase"), ClassAttribute("abstract", true))
