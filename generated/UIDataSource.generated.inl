...
HYP_BEGIN_CLASS(UIElementFactoryBase, 190, 0, NAME("ObjectBase"), ClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(UIDataSourceBase, 191, 1, NAME("ObjectBase"), ClassAttribute("abstract", true))
