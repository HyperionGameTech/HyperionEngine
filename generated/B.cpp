...
HYP_BEGIN_CLASS(HyperionEditor, 51, 0, NAME("Game"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(TextureEditorDebugOverlay, 45, 0, NAME("EditorDebugOverlayBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(TextEditorDebugOverlay, 46, 0, NAME("EditorDebugOverlayBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EditorDebugOverlayBase, 44, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(EngineDriver, 47, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EngineStats, 48, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(EngineStatGroup, 49, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(EngineStatEntry, 254, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(Game, 50, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(InputHandlerBase, 52, 3, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(NullInputHandler, 54, 0, NAME("InputHandlerBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(InputManager, 56, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_STRUCT(KeyboardEvent, 256, 0, {}, HypClassAttribute("size", 16))
...
HYP_BEGIN_ENUM(MouseButtonState, 257, 0, {})
...
HYP_BEGIN_STRUCT(MouseEvent, 258, 0, {}, HypClassAttribute("size", 56))
...
HYP_BEGIN_ENUM(MouseButtonKey, 259, 0, {})
...
HYP_BEGIN_STRUCT(PhysicsMaterial, 260, 0, {})
...
HYP_BEGIN_ENUM(PhysicsShapeType, 261, 0, {})
...
HYP_BEGIN_CLASS(RigidBody, 57, 0, NAME("HypObjectBase"))
...
HYP_BEGIN_CLASS(SpherePhysicsShape, 59, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ConvexHullPhysicsShape, 60, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(BoxPhysicsShape, 61, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PhysicsShape, 58, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PlanePhysicsShape, 62, 0, NAME("PhysicsShape"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(TonemapPass, 64, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapPass, 65, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(RaytracingPassData, 90, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(DeferredPassData, 91, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ReflectionsPass, 66, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(DeferredPass, 67, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EnvGridPass, 68, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(FullScreenPass, 63, 7, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(GaussianSplattingInstance, 71, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(GaussianSplatting, 72, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(GBuffer, 73, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(GBufferTargetName, 262, 0, {})
...
HYP_BEGIN_STRUCT(HBAOConfig, 263, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.hbao"))
...
HYP_BEGIN_CLASS(HBAO, 69, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Material, 20, 0, NAME("AssetObject"))
...
HYP_BEGIN_ENUM(MaterialTextureKey, 264, 0, {})
...
HYP_BEGIN_CLASS(MaterialGroup, 74, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(MaterialParameterValue, 265, 0, {}, HypClassAttribute("serialize", "bitwise"),HypClassAttribute("size", 16))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(MaterialParameters, 266, 0, {})
...
HYP_BEGIN_ENUM(MaterialParameterKey, 267, 0, {})
...
HYP_BEGIN_ENUM(MaterialParameterType, 268, 0, {})
...
HYP_BEGIN_STRUCT(MaterialTextures, 269, 0, {})
...
HYP_BEGIN_STRUCT(MaterialParameter, 270, 0, {})
...
HYP_BEGIN_CLASS(Mesh, 21, 0, NAME("AssetObject"))
...
HYP_BEGIN_ENUM(MeshFlags, 271, 0, {})
...
HYP_BEGIN_STRUCT(MeshInstanceData, 272, 0, {}, HypClassAttribute("postload", "MeshInstanceData_PostLoad"),HypClassAttribute("size", 104))
...
HYP_BEGIN_CLASS(ParticleSpawner, 75, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ParticleSystem, 76, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PostFXPass, 70, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(MaterialAttributeFlags, 273, 0, {})
...
HYP_BEGIN_STRUCT(MaterialAttributes, 274, 0, {})
...
HYP_BEGIN_STRUCT(MeshAttributes, 275, 0, {})
...
HYP_BEGIN_ENUM(RenderBucket, 276, 0, {})
...
HYP_BEGIN_CLASS(CommandBufferBase, 79, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ComputePipelineBase, 81, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(DescriptorSetElementType, 277, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorTableDeclaration, 278, 0, {})
...
HYP_BEGIN_CLASS(DescriptorTableBase, 83, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(DescriptorSetOffsetMap, 279, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DescriptorDeclaration, 280, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetDeclaration, 281, 0, {})
...
HYP_BEGIN_CLASS(DescriptorSetBase, 85, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(DescriptorSetDeclarationFlags, 282, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSlot, 283, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetLayoutElement, 284, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorTableOffsetMap, 285, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RendererConfig, 286, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering"))
