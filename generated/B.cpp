...
HYP_BEGIN_STRUCT(EngineStatEntry, 260, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(KeyboardEvent, 262, 0, {}, HypClassAttribute("size", 16))
...
HYP_BEGIN_STRUCT(MouseEvent, 264, 0, {}, HypClassAttribute("size", 56))
...
HYP_BEGIN_STRUCT(PhysicsMaterial, 266, 0, {})
...
HYP_BEGIN_ENUM(PhysicsShapeType, 267, 0, {})
...
HYP_BEGIN_ENUM(GBufferTargetName, 268, 0, {})
...
HYP_BEGIN_STRUCT(HBAOConfig, 269, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.hbao"))
...
HYP_BEGIN_ENUM(MaterialTextureKey, 270, 0, {})
...
HYP_BEGIN_STRUCT(MaterialParameterValue, 271, 0, {}, HypClassAttribute("serialize", "bitwise"),HypClassAttribute("size", 16))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(MaterialParameters, 272, 0, {})
...
HYP_BEGIN_ENUM(MaterialParameterKey, 273, 0, {})
...
HYP_BEGIN_ENUM(MaterialParameterType, 274, 0, {})
...
HYP_BEGIN_STRUCT(MaterialTextures, 275, 0, {})
...
HYP_BEGIN_STRUCT(MaterialParameter, 276, 0, {})
...
HYP_BEGIN_ENUM(MeshFlags, 277, 0, {})
...
HYP_BEGIN_STRUCT(MeshInstanceData, 278, 0, {}, HypClassAttribute("postload", "MeshInstanceData_OnPostLoad"),HypClassAttribute("size", 88))
...
HYP_BEGIN_ENUM(MaterialAttributeFlags, 279, 0, {})
...
HYP_BEGIN_STRUCT(MaterialAttributes, 280, 0, {})
...
HYP_BEGIN_STRUCT(MeshAttributes, 281, 0, {})
...
HYP_BEGIN_ENUM(StoreOperation, 282, 0, {})
...
HYP_BEGIN_ENUM(LoadOperation, 283, 0, {})
...
HYP_BEGIN_ENUM(RenderPassStage, 284, 0, {})
