...
HYP_BEGIN_ENUM(VisibilityStateFlags, 385, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityStateComponent, 386, 0, {}, ClassAttribute("component", true),ClassAttribute("size", 32),ClassAttribute("serialize", false),ClassAttribute("editor", false))
