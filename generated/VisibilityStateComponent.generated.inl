...
HYP_BEGIN_ENUM(VisibilityStateFlags, 390, 0, {})
...
HYP_BEGIN_STRUCT(VisibilityStateComponent, 391, 0, {}, ClassAttribute("component", true),ClassAttribute("size", 32),ClassAttribute("serialize", false),ClassAttribute("editor", false))
