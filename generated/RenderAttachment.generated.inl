...
HYP_BEGIN_ENUM(StoreOperation, 321, 0, {})
...
HYP_BEGIN_ENUM(LoadOperation, 322, 0, {})
...
HYP_BEGIN_CLASS(AttachmentBase, 97, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(RenderPassStage, 323, 0, {})
