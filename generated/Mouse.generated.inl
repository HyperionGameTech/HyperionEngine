...
HYP_BEGIN_ENUM(MouseButtonState, 277, 0, {})
...
HYP_BEGIN_STRUCT(MouseEvent, 278, 0, {}, ClassAttribute("size", 48))
...
static_assert(sizeof(MouseEvent) == 48, "Expected sizeof(MouseEvent) to be 48 bytes");
} // namespace hyperion
...
HYP_BEGIN_ENUM(MouseButtonKey, 279, 0, {})
