...
HYP_BEGIN_ENUM(RenderBucket, 285, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSetElementType, 286, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorTableDeclaration, 287, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetOffsetMap, 288, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DescriptorTableOffsetMap, 294, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RendererConfig, 295, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering"))
...
HYP_BEGIN_STRUCT(EnvProbeSphericalHarmonics, 300, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(ShaderModuleType, 301, 0, {})
...
HYP_BEGIN_ENUM(RenderStatsCountType, 302, 0, {})
...
HYP_BEGIN_STRUCT(RenderStats, 303, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RenderStatsCounts, 304, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(BlendFunction, 305, 0, {}, HypClassAttribute("serialize", "bitwise"),HypClassAttribute("size", 4))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(BlendModeFactor, 307, 0, {})
...
HYP_BEGIN_ENUM(ImageUsage, 308, 0, {})
...
HYP_BEGIN_ENUM(ResourceState, 309, 0, {})
...
HYP_BEGIN_ENUM(TextureFormat, 310, 0, {})
...
HYP_BEGIN_ENUM(TextureWrapMode, 313, 0, {})
...
HYP_BEGIN_ENUM(FaceCullMode, 314, 0, {})
...
HYP_BEGIN_STRUCT(StencilFunction, 315, 0, {})
...
HYP_BEGIN_STRUCT(TextureDesc, 316, 0, {})
...
HYP_BEGIN_ENUM(StencilCompareOp, 317, 0, {})
...
HYP_BEGIN_ENUM(ImageSupport, 318, 0, {})
...
HYP_BEGIN_ENUM(DefaultImageFormat, 320, 0, {})
...
HYP_BEGIN_ENUM(TextureType, 321, 0, {})
...
HYP_BEGIN_STRUCT(TextureData, 322, 0, {})
...
HYP_BEGIN_ENUM(TextureFilterMode, 323, 0, {})
...
HYP_BEGIN_ENUM(TextureBaseFormat, 324, 0, {})
...
HYP_BEGIN_STRUCT(SSGIConfig, 325, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.ssgi"))
...
HYP_BEGIN_STRUCT(SSRRendererConfig, 326, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.ssr"))
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 327, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.debug.debugDrawer"))
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 328, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(LightmapShadingType, 329, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 330, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "lightmapper"))
...
HYP_BEGIN_ENUM(LightmapTraceMode, 331, 0, {})
...
HYP_BEGIN_STRUCT(RaytracingReflectionsConfig, 332, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.raytracing"))
...
HYP_BEGIN_ENUM(AccelerationStructureType, 333, 0, {})
...
HYP_BEGIN_ENUM(ShaderPropertyFlags, 336, 0, {})
...
HYP_BEGIN_STRUCT(ShaderDefinition, 337, 0, {})
...
HYP_BEGIN_ENUM(ProcessShaderSourcePhase, 338, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperties, 339, 0, {})
...
HYP_BEGIN_ENUM(ShaderLanguage, 341, 0, {})
...
HYP_BEGIN_STRUCT(VertexAttributeDefinition, 342, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShaderBatch, 343, 0, {})
...
HYP_BEGIN_STRUCT(HashedShaderDefinition, 344, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsageSet, 345, 0, {})
...
HYP_BEGIN_ENUM(DescriptorUsageFlags, 346, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsageType, 347, 0, {})
...
HYP_BEGIN_ENUM(ShadowMapType, 348, 0, {})
...
HYP_BEGIN_ENUM(ShadowMapFilter, 349, 0, {})
...
HYP_BEGIN_STRUCT(ShadowMapAtlas, 350, 0, {})
...
HYP_BEGIN_STRUCT(ShadowMapAtlasElement, 351, 0, {})
HYP_END_STRUCT
