...
HYP_BEGIN_CLASS(PassData, 89, 6, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RendererConfig, 290, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering"))
HypField(NAME(HYP_STR(PathTracer)), &RendererConfig::pathTracer, offsetof(RendererConfig, pathTracer), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "raytracing.pathTracing.enabled") } }),
    ...
    HypField(NAME(HYP_STR(RaytracingGlobalIllumination)), &RendererConfig::raytracingGlobalIllumination, offsetof(RendererConfig, raytracingGlobalIllumination), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "raytracing.globalIllumination.enabled") } }),
    ...
    HypField(NAME(HYP_STR(EnvGridGiEnabled)), &RendererConfig::envGridGiEnabled, offsetof(RendererConfig, envGridGiEnabled), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "envGrid.globalIllumination.enabled") } }),
...
HYP_BEGIN_ENUM(GlobalRenderBuffer, 291, 0, {})
...
HYP_BEGIN_ENUM(GlobalRendererType, 292, 0, {})
...
HYP_BEGIN_ENUM(GpuBufferType, 293, 0, {})
...
HYP_BEGIN_STRUCT(MeshRaytracingData, 294, 0, {})
...
HYP_BEGIN_STRUCT(EnvProbeSphericalHarmonics, 295, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(RenderStatsCountType, 297, 0, {})
...
HYP_BEGIN_STRUCT(RenderStats, 298, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RenderStatsCounts, 299, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(BlendFunction, 300, 0, {}, HypClassAttribute("serialize", "bitwise"), HypClassAttribute("size", 4))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(ImageUsage, 303, 0, {})
...
HYP_BEGIN_ENUM(ResourceState, 304, 0, {})
...
HYP_BEGIN_ENUM(TextureFormat, 305, 0, {})
...
HYP_BEGIN_ENUM(GpuElemType, 306, 0, {})
...
HYP_BEGIN_ENUM(StencilOp, 307, 0, {})
...
HYP_BEGIN_ENUM(TextureWrapMode, 308, 0, {})
...
HYP_BEGIN_ENUM(FaceCullMode, 309, 0, {})
...
HYP_BEGIN_STRUCT(StencilFunction, 310, 0, {})
...
HYP_BEGIN_STRUCT(TextureDesc, 311, 0, {})
...
HYP_BEGIN_ENUM(StencilCompareOp, 312, 0, {})
...
HYP_BEGIN_ENUM(ImageSupport, 313, 0, {})
...
HYP_BEGIN_STRUCT(SSGIConfig, 320, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.ssgi"))
...
HYP_BEGIN_CLASS(SwapchainBase, 86, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RendererConfig, 321, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering"))
HypField(NAME(HYP_STR(PathTracer)), &RendererConfig::pathTracer, offsetof(RendererConfig, pathTracer), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "raytracing.pathTracing.enabled") } }),
    HypField(NAME(HYP_STR(RaytracingReflections)), &RendererConfig::raytracingReflections, offsetof(RendererConfig, raytracingReflections), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "raytracing.reflections.enabled") } }),
    HypField(NAME(HYP_STR(RaytracingGlobalIllumination)), &RendererConfig::raytracingGlobalIllumination, offsetof(RendererConfig, raytracingGlobalIllumination), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "raytracing.globalIllumination.enabled") } }),
    HypField(NAME(HYP_STR(HbaoEnabled)), &RendererConfig::hbaoEnabled, offsetof(RendererConfig, hbaoEnabled), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "hbao.enabled") } }),
...
HYP_BEGIN_ENUM(StoreOperation, 322, 0, {})
...
HYP_BEGIN_ENUM(RenderPassStage, 324, 0, {})
...
HYP_BEGIN_STRUCT(SSRRendererConfig, 328, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.ssr"))
...
HYP_BEGIN_STRUCT(MeshInstanceData, 329, 0, {}, HypClassAttribute("postload", "MeshInstanceData_OnPostLoad"), HypClassAttribute("size", 104))
...
HYP_BEGIN_CLASS(SamplerBase, 113, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(HBAOConfig, 333, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.hbao"))
...
HYP_BEGIN_CLASS(RenderSubsystem, 129, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(EnvProbeSphericalHarmonics, 339, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(ShaderProperty, 340, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsage, 341, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShader, 342, 0, {})
...
HYP_BEGIN_STRUCT(ShaderDefinition, 343, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShaderBatch, 344, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperties, 345, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DescriptorUsageSet, 346, 0, {})
...
HYP_BEGIN_ENUM(DescriptorUsageFlags, 347, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsageType, 348, 0, {})
...
HYP_BEGIN_ENUM(ShadowMapType, 349, 0, {})
...
HYP_BEGIN_ENUM(ShadowMapFilter, 350, 0, {})
...
HYP_BEGIN_CLASS(ShadowPassData, 92, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(ShadowMapAtlas, 351, 0, {})
...
HYP_BEGIN_STRUCT(ShadowMapAtlasElement, 352, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RaytracingReflectionsConfig, 353, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.raytracing"))
...
HYP_BEGIN_CLASS(TLASBase, 130, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(BLASBase, 132, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(AccelerationStructureType, 354, 0, {})
...
HYP_BEGIN_CLASS(RaytracingPipelineBase, 134, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 323, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(Lightmapper_CpuPathTracing, 137, 0, NAME("Lightmapper"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Lightmapper_GpuPathTracing, 138, 0, NAME("Lightmapper"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapperSubsystem, 164, 0, NAME("Subsystem"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightmapShadingType, 355, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 356, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "lightmapper"))
...
HYP_BEGIN_CLASS(Lightmapper, 136, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightmapTraceMode, 357, 0, {})
...
HYP_BEGIN_STRUCT(RaytracingReflectionsConfig, 327, 0, {}, HypClassAttribute("configname", "GlobalConfig"), HypClassAttribute("jsonpath", "rendering.raytracing"))
HypField(NAME(HYP_STR(Extent)), &RaytracingReflectionsConfig::extent, offsetof(RaytracingReflectionsConfig, extent), Span<const HypClassAttribute> { { HypClassAttribute("jsonignore", true) } }),
    HypField(NAME(HYP_STR(PathTracing)), &RaytracingReflectionsConfig::pathTracing, offsetof(RaytracingReflectionsConfig, pathTracing), Span<const HypClassAttribute> { { HypClassAttribute("jsonpath", "pathTracing.enabled") } })
        HYP_END_STRUCT
...
HYP_BEGIN_ENUM(AccelerationStructureType, 328, 0, {})
HypConstant(NAME(HYP_STR(BOTTOM_LEVEL)), AccelerationStructureType::BOTTOM_LEVEL),
    HypConstant(NAME(HYP_STR(TOP_LEVEL)), AccelerationStructureType::TOP_LEVEL)
        HYP_END_ENUM
...
HYP_BEGIN_STRUCT(ShaderProperty, 329, 0, {})
HypField(NAME(HYP_STR(Name)), &ShaderProperty::name, offsetof(ShaderProperty, name)),
    HypField(NAME(HYP_STR(IsPermutation)), &ShaderProperty::isPermutation, offsetof(ShaderProperty, isPermutation)),
    HypField(NAME(HYP_STR(Flags)), &ShaderProperty::flags, offsetof(ShaderProperty, flags)),
    HypField(NAME(HYP_STR(CurrentValue)), &ShaderProperty::currentValue, offsetof(ShaderProperty, currentValue)),
...
HYP_BEGIN_STRUCT(ShaderDefinition, 332, 0, {})
HypField(NAME(HYP_STR(Name)), &ShaderDefinition::name, offsetof(ShaderDefinition, name)),
    HypField(NAME(HYP_STR(Properties)), &ShaderDefinition::properties, offsetof(ShaderDefinition, properties))
        HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(CompiledShaderBatch, 333, 0, {})
HypField(NAME(HYP_STR(CompiledShaders)), &CompiledShaderBatch::compiledShaders, offsetof(CompiledShaderBatch, compiledShaders)),
    HypField(NAME(HYP_STR(ErrorMessages)), &CompiledShaderBatch::errorMessages, offsetof(CompiledShaderBatch, errorMessages))
        HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(ShaderProperties, 334, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DescriptorUsageSet, 335, 0, {})
HypField(NAME(HYP_STR(Elements)), &DescriptorUsageSet::elements, offsetof(DescriptorUsageSet, elements))
    HYP_END_STRUCT
...
HYP_BEGIN_ENUM(DescriptorUsageFlags, 336, 0, {})
HypConstant(NAME(HYP_STR(NONE)), DescriptorUsageFlags::NONE),
    HypConstant(NAME(HYP_STR(DYNAMIC)), DescriptorUsageFlags::DYNAMIC)
        HYP_END_ENUM
...
HYP_BEGIN_STRUCT(DescriptorUsageType, 337, 0, {})
HypField(NAME(HYP_STR(Name)), &DescriptorUsageType::name, offsetof(DescriptorUsageType, name), Span<const HypClassAttribute> { { HypClassAttribute("property", "Name"), HypClassAttribute("serialize", true) } }),
    HypField(NAME(HYP_STR(Size)), &DescriptorUsageType::size, offsetof(DescriptorUsageType, size), Span<const HypClassAttribute> { { HypClassAttribute("property", "Size"), HypClassAttribute("serialize", true) } }),
    HypField(NAME(HYP_STR(FieldNames)), &DescriptorUsageType::fieldNames, offsetof(DescriptorUsageType, fieldNames), Span<const HypClassAttribute> { { HypClassAttribute("property", "FieldNames"), HypClassAttribute("serialize", true) } }),
    HypField(NAME(HYP_STR(FieldTypes)), &DescriptorUsageType::fieldTypes, offsetof(DescriptorUsageType, fieldTypes), Span<const HypClassAttribute> { { HypClassAttribute("property", "FieldTypes"), HypClassAttribute("serialize", true) } })
...
HYP_BEGIN_ENUM(ShadowMapType, 338, 0, {})
HypConstant(NAME(HYP_STR(SMT_DIRECTIONAL)), ShadowMapType::SMT_DIRECTIONAL),
    HypConstant(NAME(HYP_STR(SMT_SPOT)), ShadowMapType::SMT_SPOT),
    HypConstant(NAME(HYP_STR(SMT_OMNI)), ShadowMapType::SMT_OMNI)
        HYP_END_ENUM
...
HYP_BEGIN_ENUM(ShadowMapFilter, 339, 0, {})
HypConstant(NAME(HYP_STR(SMF_STANDARD)), ShadowMapFilter::SMF_STANDARD),
    HypConstant(NAME(HYP_STR(SMF_PCF)), ShadowMapFilter::SMF_PCF),
    HypConstant(NAME(HYP_STR(SMF_CONTACT_HARDENED)), ShadowMapFilter::SMF_CONTACT_HARDENED),
    HypConstant(NAME(HYP_STR(SMF_VSM)), ShadowMapFilter::SMF_VSM),
...
HYP_BEGIN_STRUCT(ShadowMapAtlas, 340, 0, {})
HypProperty(NAME(HYP_STR(AtlasDimensions)), &ShadowMapAtlas::atlasDimensions),
    HypProperty(NAME(HYP_STR(Elements)), &ShadowMapAtlas::elements),
    HypProperty(NAME(HYP_STR(FreeSpaces)), &ShadowMapAtlas::freeSpaces),
    HypField(NAME(HYP_STR(AtlasIndex)), &ShadowMapAtlas::atlasIndex, offsetof(ShadowMapAtlas, atlasIndex), Span<const HypClassAttribute> { { HypClassAttribute("property", "AtlasIndex"), HypClassAttribute("serialize", true) } })
...
HYP_BEGIN_STRUCT(ShadowMapAtlasElement, 341, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(VulkanDeviceQueueType, 342, 0, {})
...
HYP_BEGIN_STRUCT(BVHNode, 343, 0, {})
...
HYP_BEGIN_STRUCT(ComponentInfo, 345, 0, {}, HypClassAttribute("size", 12))
