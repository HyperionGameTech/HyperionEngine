...
HYP_BEGIN_ENUM(RenderBucket, 286, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSetElementType, 287, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetOffsetMap, 289, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(DescriptorTableOffsetMap, 295, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RendererConfig, 296, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Rendering"))
...
HYP_BEGIN_ENUM(GlobalRenderBuffer, 297, 0, {})
...
HYP_BEGIN_ENUM(GlobalRendererType, 298, 0, {})
...
HYP_BEGIN_ENUM(GpuBufferType, 299, 0, {})
...
HYP_BEGIN_STRUCT(MeshRaytracingData, 300, 0, {})
...
HYP_BEGIN_STRUCT(EnvProbeSphericalHarmonics, 301, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(ShaderModuleType, 302, 0, {})
...
HYP_BEGIN_ENUM(RenderStatsCountType, 303, 0, {})
...
HYP_BEGIN_STRUCT(RenderStats, 304, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RenderStatsCounts, 305, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(BlendFunction, 306, 0, {}, HypClassAttribute("serialize", "bitwise"),HypClassAttribute("size", 4))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(BlendModeFactor, 308, 0, {})
...
HYP_BEGIN_ENUM(ImageUsage, 309, 0, {})
...
HYP_BEGIN_ENUM(ResourceState, 310, 0, {})
...
HYP_BEGIN_ENUM(TextureFormat, 311, 0, {})
...
HYP_BEGIN_ENUM(FaceCullMode, 315, 0, {})
...
HYP_BEGIN_STRUCT(StencilFunction, 316, 0, {})
...
HYP_BEGIN_STRUCT(TextureDesc, 317, 0, {})
...
HYP_BEGIN_ENUM(StencilCompareOp, 318, 0, {})
...
HYP_BEGIN_ENUM(ImageSupport, 319, 0, {})
...
HYP_BEGIN_ENUM(DefaultImageFormat, 321, 0, {})
...
HYP_BEGIN_ENUM(TextureType, 322, 0, {})
...
HYP_BEGIN_STRUCT(TextureData, 323, 0, {})
...
HYP_BEGIN_ENUM(TextureBaseFormat, 325, 0, {})
...
HYP_BEGIN_STRUCT(SSGIConfig, 326, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Rendering.SSGI"))
...
HYP_BEGIN_STRUCT(DebugDrawerConfig, 328, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Rendering.Debug.DebugDrawer"))
...
HYP_BEGIN_STRUCT(FontAtlasTextureSet, 329, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(Lightmapper_CpuPathTracing, 121, 0, NAME("LightmapperBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Lightmapper_GpuPathTracing, 122, 0, NAME("LightmapperBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapperBase, 120, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightmapShadingType, 330, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 331, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Lightmapper"))
...
HYP_BEGIN_CLASS(LightmapperSubsystem, 150, 0, NAME("Subsystem"))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RaytracingReflectionsConfig, 333, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "Rendering.RayTracing"))
...
HYP_BEGIN_CLASS(TLASBase, 123, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(BLASBase, 125, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(AccelerationStructureType, 334, 0, {})
...
HYP_BEGIN_CLASS(RaytracingPipelineBase, 127, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(DescriptorUsage, 335, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShader, 336, 0, {})
...
HYP_BEGIN_ENUM(ShaderPropertyFlags, 337, 0, {})
...
HYP_BEGIN_STRUCT(ShaderDefinition, 338, 0, {})
...
HYP_BEGIN_ENUM(ProcessShaderSourcePhase, 339, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperties, 340, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperty, 341, 0, {})
...
HYP_BEGIN_ENUM(ShaderLanguage, 342, 0, {})
...
HYP_BEGIN_STRUCT(VertexAttributeDefinition, 343, 0, {})
...
HYP_BEGIN_STRUCT(HashedShaderDefinition, 345, 0, {})
