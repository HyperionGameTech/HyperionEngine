...
HYP_BEGIN_CLASS(TonemapPass, 120, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(LightmapPass, 121, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(RaytracingPassData, 87, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(DeferredPassData, 88, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ReflectionsPass, 122, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(DeferredPass, 123, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EnvGridPass, 124, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(PassData, 86, 6, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RendererConfig, 317, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering"))
...
HYP_BEGIN_CLASS(GaussianSplattingInstance, 93, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(GaussianSplatting, 94, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(GpuBufferType, 318, 0, {})
...
HYP_BEGIN_ENUM(ShaderModuleType, 319, 0, {})
...
HYP_BEGIN_ENUM(GBufferTargetName, 320, 0, {})
...
HYP_BEGIN_CLASS(PostFXPass, 125, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(RenderGroup, 102, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ParticleSpawner, 107, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ParticleSystem, 108, 0, NAME("HypObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(MeshInstanceData, 322, 0, {}, HypClassAttribute("postload", "MeshInstanceData_PostLoad"),HypClassAttribute("size", 104))
...
static const HypClassCallbackRegistration<HypClassCallbackType::ON_POST_LOAD> g_post_load_MeshInstanceData(TypeId::ForType<MeshInstanceData>(), ValueWrapper<MeshInstanceData_PostLoad>());
} // namespace hyperion
...
HYP_BEGIN_ENUM(MaterialAttributeFlags, 323, 0, {})
...
HYP_BEGIN_STRUCT(MaterialAttributes, 324, 0, {})
...
HYP_BEGIN_STRUCT(MeshAttributes, 325, 0, {})
...
HYP_BEGIN_CLASS(Texture, 50, 0, NAME("AssetObject"))
...
HYP_BEGIN_CLASS(GpuImageViewBase, 115, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true),HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(HBAOConfig, 326, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.hbao"))
...
HYP_BEGIN_CLASS(HBAO, 126, 0, NAME("FullScreenPass"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(RenderStatsCountType, 327, 0, {})
...
HYP_BEGIN_STRUCT(RenderStats, 328, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RenderStatsCounts, 329, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(FullScreenPass, 119, 7, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Mesh, 51, 0, NAME("AssetObject"))
    ...
    HypMethod(NAME(HYP_STR(GetAssetReference)), &Mesh::GetAssetReference, Span<const HypClassAttribute> { {HypClassAttribute("property", "AssetReference") } }),
    ...
    HypMethod(NAME(HYP_STR(SetAssetReference)), &Mesh::SetAssetReference, Span<const HypClassAttribute> { {HypClassAttribute("property", "AssetReference") } }),
...
HYP_BEGIN_ENUM(MeshFlags, 330, 0, {})
...
HYP_BEGIN_CLASS(RenderSubsystem, 127, 0, NAME("HypObjectBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(MeshRaytracingData, 331, 0, {})
...
HYP_BEGIN_STRUCT(EnvProbeSphericalHarmonics, 332, 0, {}, HypClassAttribute("serialize", "bitwise"))
HYP_END_STRUCT
...
HYP_BEGIN_CLASS(ShadowPassData, 90, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RaytracingReflectionsConfig, 346, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "rendering.raytracing"))
...
HYP_BEGIN_CLASS(EnvGridPassData, 91, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Lightmapper_CpuPathTracing, 135, 0, NAME("Lightmapper"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Lightmapper_GpuPathTracing, 136, 0, NAME("Lightmapper"))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightmapShadingType, 347, 0, {})
...
HYP_BEGIN_STRUCT(LightmapperConfig, 348, 0, {}, HypClassAttribute("configname", "GlobalConfig"),HypClassAttribute("jsonpath", "lightmapper"))
...
HYP_BEGIN_CLASS(Lightmapper, 134, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(LightmapTraceMode, 349, 0, {})
...
HYP_BEGIN_CLASS(EnvProbePassData, 92, 0, NAME("PassData"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(VulkanDescriptorSet, 80, 0, NAME("DescriptorSetBase"), HypClassAttribute("noscriptbindings", true))
HYP_END_CLASS
