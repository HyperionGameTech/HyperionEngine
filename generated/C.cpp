...
HYP_BEGIN_STRUCT(DescriptorTableDeclaration, 280, 0, {})
...
HYP_BEGIN_STRUCT(RendererConfig, 286, 0, {}, ClassAttribute("configname", "GlobalConfig"),ClassAttribute("jsonpath", "Rendering"))
...
HYP_BEGIN_ENUM(ShaderModuleType, 291, 0, {})
...
HYP_BEGIN_ENUM(RenderStatsCountType, 292, 0, {})
...
HYP_BEGIN_STRUCT(RenderStats, 293, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(RenderStatsCounts, 294, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_STRUCT(BlendFunction, 295, 0, {}, ClassAttribute("serialize", "bitwise"),ClassAttribute("size", 4))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(BlendModeFactor, 297, 0, {})
...
HYP_BEGIN_ENUM(GpuElemType, 298, 0, {})
...
HYP_BEGIN_ENUM(StencilOp, 299, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSetElementType, 300, 0, {})
...
HYP_BEGIN_ENUM(TextureWrapMode, 301, 0, {})
...
HYP_BEGIN_ENUM(StencilCompareOp, 302, 0, {})
...
HYP_BEGIN_ENUM(ImageSupport, 303, 0, {})
...
HYP_BEGIN_ENUM(DefaultImageFormat, 305, 0, {})
...
HYP_BEGIN_ENUM(TextureType, 306, 0, {})
...
HYP_BEGIN_STRUCT(TextureData, 307, 0, {})
...
HYP_BEGIN_ENUM(TextureBaseFormat, 308, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorTableOffsetMap, 309, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(StoreOperation, 310, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetOffsetMap, 311, 0, {})
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(ImageUsage, 312, 0, {})
...
HYP_BEGIN_ENUM(ResourceState, 313, 0, {})
...
HYP_BEGIN_ENUM(TextureFormat, 314, 0, {})
...
HYP_BEGIN_ENUM(LoadOperation, 318, 0, {})
