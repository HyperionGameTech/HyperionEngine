...
HYP_BEGIN_STRUCT(DescriptorUsage, 327, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShader, 328, 0, {})
...
HYP_BEGIN_ENUM(ShaderPropertyFlags, 329, 0, {})
...
HYP_BEGIN_STRUCT(ShaderDefinition, 330, 0, {})
...
HYP_BEGIN_ENUM(ProcessShaderSourcePhase, 331, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperties, 332, 0, {})
...
HYP_BEGIN_STRUCT(ShaderProperty, 333, 0, {})
    ...
    Field(NAME(HYP_STR(CachedHashCode)), &ShaderProperty::cachedHashCode, offsetof(ShaderProperty, cachedHashCode), Span<const ClassAttribute> { {ClassAttribute("transient", true) } })
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(ShaderLanguage, 334, 0, {})
...
HYP_BEGIN_STRUCT(VertexAttributeDefinition, 335, 0, {})
...
HYP_BEGIN_STRUCT(CompiledShaderBatch, 336, 0, {})
...
HYP_BEGIN_STRUCT(HashedShaderDefinition, 337, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsageSet, 338, 0, {})
...
HYP_BEGIN_ENUM(DescriptorUsageFlags, 339, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorUsageType, 340, 0, {})
