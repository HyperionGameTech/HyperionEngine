...
HYP_BEGIN_STRUCT(DescriptorTableDeclaration, 295, 0, {})
...
HYP_BEGIN_CLASS(DescriptorTableBase, 81, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(DescriptorDeclaration, 296, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetDeclaration, 297, 0, {})
...
HYP_BEGIN_CLASS(DescriptorSetBase, 83, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(DescriptorSetDeclarationFlags, 298, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSlot, 299, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetLayoutElement, 300, 0, {})
