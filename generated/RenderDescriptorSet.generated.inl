...
HYP_BEGIN_STRUCT(DescriptorTableDeclaration, 296, 0, {})
...
HYP_BEGIN_CLASS(DescriptorTableBase, 82, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(DescriptorDeclaration, 297, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetDeclaration, 298, 0, {})
...
HYP_BEGIN_CLASS(DescriptorSetBase, 84, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_ENUM(DescriptorSetDeclarationFlags, 299, 0, {})
...
HYP_BEGIN_ENUM(DescriptorSlot, 300, 0, {})
...
HYP_BEGIN_STRUCT(DescriptorSetLayoutElement, 301, 0, {})
