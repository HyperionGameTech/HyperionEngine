...
HYP_BEGIN_CLASS(EditorActionBase, 200, 1, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
...
HYP_BEGIN_CLASS(EditorSubsystem, 165, 0, NAME("Subsystem"))
...
HYP_BEGIN_CLASS(EditorManipulationWidgetBase, 206, 2, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EditorMain, 214, 0, NAME("HypObjectBase"))
