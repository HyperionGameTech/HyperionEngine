...
HYP_BEGIN_CLASS(EditorSubsystem, 167, 0, NAME("Subsystem"))
...
HYP_BEGIN_CLASS(FpsCounter, 212, 0, NAME("EditorDebugOverlayBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(StatOverlay, 213, 0, NAME("EditorDebugOverlayBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(EditorDebugOverlayBase, 211, 4, NAME("HypObjectBase"), HypClassAttribute("abstract", true))
