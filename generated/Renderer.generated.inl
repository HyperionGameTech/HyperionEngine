...
HYP_BEGIN_CLASS(PassData, 91, 6, NAME("ObjectBase"), ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RendererConfig, 336, 0, {}, ClassAttribute("configname", "GlobalConfig"),ClassAttribute("jsonpath", "Rendering"))
