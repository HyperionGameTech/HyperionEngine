...
HYP_BEGIN_CLASS(PassData, 94, 7, NAME("ObjectBase"), ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
...
HYP_BEGIN_STRUCT(RendererConfig, 295, 0, {}, ClassAttribute("configname", "GlobalConfig"),ClassAttribute("jsonpath", "Rendering"))
