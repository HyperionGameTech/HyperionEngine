...
HYP_BEGIN_ENUM(GpuBufferType, 337, 0, {})
...
HYP_BEGIN_CLASS(GpuBufferBase, 102, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
