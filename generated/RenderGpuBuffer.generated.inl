...
HYP_BEGIN_ENUM(GpuBufferType, 298, 0, {})
...
HYP_BEGIN_CLASS(GpuBufferBase, 106, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
