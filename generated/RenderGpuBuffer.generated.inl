...
HYP_BEGIN_ENUM(GpuBufferType, 336, 0, {})
...
HYP_BEGIN_CLASS(GpuBufferBase, 101, 1, NAME("ObjectBase"), ClassAttribute("abstract", true),ClassAttribute("noscriptbindings", true))
HYP_END_CLASS
