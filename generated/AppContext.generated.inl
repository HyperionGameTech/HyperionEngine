...
HYP_BEGIN_CLASS(SDLAppContext, 74, 0, NAME("AppContextBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AppContextBase, 73, 2, NAME("ObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SDLApplicationWindow, 77, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32ApplicationWindow, 78, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ApplicationWindow, 76, 2, NAME("ObjectBase"), ClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32AppContext, 75, 0, NAME("AppContextBase"))
HYP_END_CLASS
