...
HYP_BEGIN_CLASS(SDLAppContext, 73, 0, NAME("AppContextBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(AppContextBase, 72, 2, NAME("ObjectBase"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(SDLApplicationWindow, 76, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32ApplicationWindow, 77, 0, NAME("ApplicationWindow"))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(ApplicationWindow, 75, 2, NAME("ObjectBase"), ClassAttribute("abstract", true))
HYP_END_CLASS
...
HYP_BEGIN_CLASS(Win32AppContext, 74, 0, NAME("AppContextBase"))
HYP_END_CLASS
