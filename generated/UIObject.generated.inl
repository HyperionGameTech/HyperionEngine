...
HYP_BEGIN_CLASS(UIObject, 194, 22, NAME("ObjectBase"), ClassAttribute("abstract", true))
...
HYP_BEGIN_STRUCT(UIObjectSize, 406, 0, {})
...
HYP_BEGIN_STRUCT(UIObjectAspectRatio, 407, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateSizeFlags, 408, 0, {})
...
HYP_BEGIN_ENUM(UIObjectAlignment, 409, 0, {})
...
HYP_BEGIN_STRUCT(UIEventHandlerResult, 410, 0, {}, ClassAttribute("size", 24))
HYP_END_STRUCT
...
HYP_BEGIN_ENUM(UIObjectBorderFlags, 411, 0, {})
...
HYP_BEGIN_ENUM(UIObjectUpdateType, 412, 0, {})
...
HYP_BEGIN_ENUM(UIObjectFocusState, 413, 0, {})
...
HYP_BEGIN_ENUM(ScrollAxis, 414, 0, {})
