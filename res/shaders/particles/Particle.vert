...
HYP_DESCRIPTOR_CBUFF(ParticleDescriptorSet, WorldsBuffer) uniform WorldsBuffer
{
    WorldShaderData world_shader_data;
};

HYP_DESCRIPTOR_CBUFF_DYNAMIC(ParticleDescriptorSet, CamerasBuffer) uniform CamerasBuffer
{
    Camera camera;
};
